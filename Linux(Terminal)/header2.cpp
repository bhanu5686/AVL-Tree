...
using namespace std;
        ...
        //Defualt constructo of AVL_Tree class
        AVL_Tree :: AVL_Tree()
        {
            root=NULL;
            head=NULL;
        ...
        //Private method of AVL_Tree class
        bool AVL_Tree :: AVL_Search(AVL_Node *root,int k)
        {
            if(root==NULL)
                return false;
            else if(root->data==k)
        ...
        //Private method of AVL_Tree class
        void AVL_Tree :: printAVL(AVL_Node* root, FILE* stream)
        {
        ...
        //Private method of AVL_Tree class
        void AVL_Tree :: printLevelOrder(AVL_Node *root,FILE* stream)
        {
            static int c = 1;
            static int cnt = 1;
            if (root == NULL)
        ...
        //Public method of AVL_Tree class
